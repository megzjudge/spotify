...
- Pulls a curated view of your Spotify library live - pulled easily from the [Spotify Web API](https://developer.spotify.com/documentation/web-api), with playlists grouped into sections (Daily Mix, Top, Other), a featured podcast playlist, and a set of highlighted "others" playlists.
